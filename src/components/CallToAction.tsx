    ...
    <section id="contact" className="py-32 md:py-29 bg-primary text-primary-foreground">
      <div className="container mx-auto px-6 md:px-12">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {submitted ? (
            <div className="max-w-md mx-auto py-8 px-6 border border-primary-foreground/30 rounded-2xl text-center">
              <p className="text-primary-foreground text-lg font-medium mb-2">Открываем почту...</p>
              <p className="text-primary-foreground/70 text-sm">Отправьте письмо — мы ответим в течение дня.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="max-w-md mx-auto flex flex-col gap-4">
              <input
                ...
                required
                className="w-full bg-white/10 border border-primary-foreground/30 rounded-xl px-5 py-4 text-sm text-primary-foreground placeholder:text-primary-foreground/60 focus:outline-none focus:border-primary-foreground transition-colors"
              />
              <input
                type="tel"
                placeholder="Телефон"
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-3 bg-white text-primary px-8 py-4 rounded-full text-sm font-semibold tracking-wide hover:bg-white/90 transition-colors duration-300 group"
              >
                Получить прайс-лист
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </button>
              <p className="text-primary-foreground/60 text-xs">Нажимая кнопку, вы соглашаетесь на обработку персональных данных</p>
            </form>
          )}
