...
const categories = [
  {
    ...
    unit: "от 500 шт",
    items: ["Классические ароматные", "Мини-формат 100 мл", "Большого объёма 155 мл", "Шоколадные", "Розовые"],
  },
  {
    id: "cones",
    label: "Рожки",
    ...
    unit: "от 500 шт",
    items: ["Сахарные классические", "Сахарные большие", "Комбо-набор рожки и стаканчики"],
  },
  {
    id: "sheets",
    label: "Коржи",
    ...
    unit: "от 100 шт",
    items: ["Круглые классические", "Шоколадные с какао", "Разноцветные", "Цветочек", "Сердечко"],
  },
  {
    id: "tartlets",
    label: "Тарталетки",
    ...
    unit: "от 200 шт",
    items: ["Корзинка", "Лукошко", "Солнышко", "Лодочки", "Орешек"],
  },
]
