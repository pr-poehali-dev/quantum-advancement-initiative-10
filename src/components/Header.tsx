    ...
    <header
      className={cn(
        ...
        scrolled || mobileMenuOpen
          ? "bg-foreground backdrop-blur-md py-4 top-4 left-4 right-4 rounded-2xl shadow-lg"
          : "bg-transparent py-5 top-0 left-0 right-0",
      )}
    >
      <nav className="container mx-auto px-6 flex items-center justify-between md:px-[24]">
        ...
        <ul className="hidden md:flex items-center gap-10 text-base font-bold tracking-wide">
          {[
            ...
            { label: "Маркетплейсы", href: "#marketplace-feedback" },
