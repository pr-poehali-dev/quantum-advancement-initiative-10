...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Да, мы работаем по схеме private label. Подберём продукцию у проверенных производителей и организуем фасовку в упаковку с вашим брендом. Обсудим объёмы и условия индивидуально.",
  },
  {
